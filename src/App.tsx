  ...
  return (
    ...
    >
      <Navbar.Root className="gap-3">
        ...
        <Navbar.Right>
          <Navbar.Container
            title="jPRO.Atende 2.0"
            subtitle="&copy; Prodesan - 2023"
          />
        </Navbar.Right>
      </Navbar.Root>
      <div className="flex justify-center items-center">
        <FilterCard.Root
          ...
          dataModel={columns}
          action={(
            <FilterCard.Action href={'/'} label="Nova Solicitação" className="mt-3 bg-blue-500" variant="contained" linkWrapper={Link} />
          )}
          footer={
            (<Container>
