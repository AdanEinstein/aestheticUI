...
export default function DataGridActionsDelete({ className, color = 'error', endIcon = <EventBusyIcon/>, label, variant = 'contained', children, ...rest }: PropsWithChildren<IDataGridActionsDeleteProps>) {
